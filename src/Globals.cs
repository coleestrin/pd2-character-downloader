...
namespace D2SLib
{
    public static class Globals
    {
        ...
        public static readonly string savePath = "C:\\Program Files (x86)\\Diablo II\\Save\\Skjutglad.d2s"; // for reading local D2S files -- Change this to your D2 save file path
        public static readonly string savePath2 = "C:\\Program Files (x86)\\Diablo II\\Save\\comparison character\\Skjutglad.d2s"; // for reading local D2s file to compare -- Change this to a folder where you have another D2S file for comparison
